...
/* Preguntas inventadas en base a la web LUMENYX */
const FAQ_ITEMS = [
  {
    q: "¿Qué diferencia hay entre los modelos i5 / i7 y cuál me conviene para diseño o gaming?",
    a: "Los i7 ofrecen mayor rendimiento en multitarea y en tareas intensivas (render, edición, gaming exigente). Para uso de oficina y programación, un i5 con buena RAM suele ser suficiente; para edición de video o gaming con alta calidad, recomendamos i7 y GPU dedicada."
  },
  {
    q: "¿Qué incluye la garantía de 2 años y cómo gestiono un reclamo?",
    a: "La garantía cubre defectos de fabricación en hardware durante 24 meses. Para reclamos contactá soporte con el número de pedido; te indicaremos el centro de servicio o la gestión de recogida y reparación."
  },
  {
    q: "¿Cuánto tarda el envío y qué coste tiene a España peninsular?",
    a: "El envío estándar tarda entre 2 y 4 días hábiles en la península. El coste se calcula en el checkout; a veces ofrecemos envío gratuito por promociones o importe mínimo."
  },
  {
    q: "¿Puedo devolver un equipo si no cumple mis expectativas? ¿Cuál es el proceso?",
    a: "Sí: disponés de 14 días para cambiar o devolver (equipo en condiciones originales). Abrí un ticket con soporte, te enviamos instrucciones y la etiqueta de devolución si corresponde."
  },
  {
    q: "¿Los equipos vienen con sistema operativo y drivers instalados?",
    a: "Los equipos se entregan con el sistema operativo y los drivers básicos según la configuración elegida. Recomendamos verificar actualizaciones y drivers del fabricante al recibir el equipo."
  },
  {
    q: "¿Qué accesorios y opciones de ampliación puedo agregar (RAM, SSD)?",
    a: "Muchos modelos permiten ampliaciones. Consultá la ficha técnica de cada producto o contactá ventas para presupuestos de ampliación e instalación."
  },
  {
    q: "¿Cómo funciona el soporte técnico y qué canales hay para contactarlo?",
    a: "Ofrecemos soporte por email y WhatsApp; también servicio telefónico para casos urgentes. Tené a mano tu número de pedido para acelerar la atención."
  },
  {
    q: "¿Los videos en la página muestran rendimiento real de los equipos?",
    a: "Los videos son demos orientativas con configuraciones específicas. Si necesitás benchmarks concretos para una configuración, solicitálos y te los facilitamos."
  }
];
...
/* Inicializamos en DOMContentLoaded */
document.addEventListener('DOMContentLoaded', () => {
  try {
